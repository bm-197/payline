...
--> statement-breakpoint
ALTER TABLE "business_profile" ADD COLUMN "organization_id" text;--> statement-breakpoint
ALTER TABLE "client" ADD COLUMN "organization_id" text;--> statement-breakpoint
ALTER TABLE "invoice" ADD COLUMN "organization_id" text;--> statement-breakpoint
